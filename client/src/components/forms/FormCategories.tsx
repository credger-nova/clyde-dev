        ...
        >
            <List sx={{ padding: "10px" }}>
                <React.Fragment key="All">
                    <StyledListItemButton selected={props.category === "All"} onClick={() => props.setCategory("All")}>
                        <ListItemText>All</ListItemText>
                    </StyledListItemButton>
                </React.Fragment>
                {categories.map((cat) => (
                    <React.Fragment key={cat}>
                        <StyledListItemButton selected={cat === props.category} onClick={() => props.setCategory(cat)}>
