...
export default function EditDialog(props: Props) {
    ...
    return (
        partsReq && (
            ...
            >
                <DialogTitle sx={{ textAlign: "center", padding: "5px" }}>Parts Requisition #{partsReq.id}</DialogTitle>
                ...
                {!edit && (
                    <DialogActions>
                        ...
                        >
                            <MenuItem onClick={() => handleGeneratePDF(partsReq.id, true)} disableRipple>
                                <AttachMoneyIcon />
                                With Pricing
                            </MenuItem>
                            <MenuItem onClick={() => handleGeneratePDF(partsReq.id, false)} disableRipple>
                                <MoneyOffIcon />
                                Without Pricing
                            </MenuItem>
                        </Menu>
