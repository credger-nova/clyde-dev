...
export function SkeletonCard() {
    return (
        ...
        >
            <CardHeader
                sx={{ padding: "5px" }}
                title={<Skeleton animation={"wave"} sx={{ width: "80%" }} />}
                subheader={<Skeleton animation={"wave"} sx={{ width: "60%" }} />}
            ></CardHeader>
            <Divider />
            <CardContent sx={{ padding: "5px" }}>
                <Skeleton animation={"wave"} sx={{ width: "80%", marginBottom: "5px" }} />
                <Skeleton animation={"wave"} sx={{ width: "80%", marginBottom: "5px" }} />
                <Skeleton animation={"wave"} sx={{ width: "80%", marginBottom: "5px" }} />
                <Skeleton animation={"wave"} sx={{ width: "80%", marginBottom: "5px" }} />
                <Skeleton animation={"wave"} sx={{ width: "80%", marginBottom: "5px" }} />
            ...
            <Divider />
            <CardContent sx={{ padding: "5px" }}>
                <Skeleton animation={"wave"} sx={{ width: "40%", marginBottom: "5px" }} />
                <Skeleton animation={"wave"} sx={{ width: "40%", marginBottom: "5px" }} />
            </CardContent>
        </Card>
    )
...
export default function PartsReqCard(props: Props) {
    ...
    return (
        <Link component={RouterLink} to={`${partsReq.id}`} underline="none">
            <StyledCard
                sx={{
                    height: "285px",
                    width: "325px",
            ...
            >
                ...
                <CardContent sx={{ padding: "5px" }}>
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                        <Typography variant="caption">{`Estimated Cost: $${calcCost(partsReq.parts).toFixed(2)}`}</Typography>
                        {
