...
export default function TestingSplashPage(props: Props) {
    ...
    return (
        <div className="page-container" style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            <img src="https://res.cloudinary.com/dvdturlak/image/upload/v1701810257/Kepler/nova-simple_yrdti4.svg" style={{ height: "5em" }} />
            <Divider sx={{ width: "50%" }} />
            <Typography variant="h4" sx={{ fontWeight: 600, color: "red" }}>
                ATTENTION!
            </Typography>
            <Typography variant="body2" sx={{ width: "50%", textAlign: "center", marginTop: "10px" }}>
                You are attempting to connect to the Kepler testing site. Please verify that you are correctly accessing the testing site or click the
                button below to be redirected to the main Kepler site.
            </Typography>
            <div style={{ width: "100%", display: "flex", flexDirection: "row", justifyContent: "center", marginTop: "10px" }}>
                <Button onClick={handleTestClick} variant="outlined" sx={{ marginRight: "5px" }}>
                    Continue to testing
                </Button>
                <Button
